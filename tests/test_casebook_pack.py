"""Regression checks for the juliaqueue casebook."""
...
from casebook.harness import assert_expected, juliaqueue_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(juliaqueue_summary(), assert_expected())
